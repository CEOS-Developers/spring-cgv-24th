...
public class FavoriteTheaterService {
    ...
    public void deleteFavoriteTheater(Long favoriteTheaterId, Long memberId) {
        FavoriteTheater favoriteTheater = favoriteTheaterRepository.findById(favoriteTheaterId)
    ...
    public GetTheaterResponse getAllFavoriteTheaters(Long memberId) {
        ...
        List<TheaterInfo> theaters = favoriteTheaterRepository.findAllByMemberId(member.getId())
                .stream()
